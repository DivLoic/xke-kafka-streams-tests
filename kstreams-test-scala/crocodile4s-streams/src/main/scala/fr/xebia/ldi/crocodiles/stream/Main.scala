...
import fr.xebia.ldi.crocodiles.common.CrocoTools
import fr.xebia.ldi.crocodiles.common.model.{Click, Coupon, Link, Purchase}
import fr.xebia.ldi.crocodiles.stream.config.CrocoConf
import fr.xebia.ldi.crocodiles.stream.operator.{Joiners, Mappers, Predicates, Processors}
