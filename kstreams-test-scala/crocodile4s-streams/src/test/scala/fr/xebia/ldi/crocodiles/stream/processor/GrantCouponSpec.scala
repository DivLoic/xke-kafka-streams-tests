package fr.xebia.ldi.crocodiles.stream.processor

import java.time.{LocalDate, LocalDateTime}

import com.madewithtea.mockedstreams.MockedStreams
import fr.xebia.ldi.crocodiles.common.model.Client.ClientKey
import fr.xebia.ldi.crocodiles.common.model.Gender.F
import fr.xebia.ldi.crocodiles.common.model.ItemCategory.Cloth
import fr.xebia.ldi.crocodile.common.model.{Coupon, Item, Purchase}
...
import fr.xebia.ldi.crocodiles.common.model.{Coupon, Item, Purchase, Voucher}
import fr.xebia.ldi.crocodiles.stream.CrocoSpec
import fr.xebia.ldi.crocodiles.stream.model.{ActiveLink, UsedLink}
import fr.xebia.ldi.crocodiles.stream.operator.Processors
