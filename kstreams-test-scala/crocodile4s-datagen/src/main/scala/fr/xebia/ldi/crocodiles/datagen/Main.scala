package fr.xebia.ldi.crocodiles.datagen
...
import fr.xebia.ldi.crocodiles.common.model.Gender.{F, M}
import fr.xebia.ldi.crocodile.common.model._
import fr.xebia.ldi.crocodiles.common.CommonSerdes
import fr.xebia.ldi.crocodiles.common.model.{Click, Client, Item, ItemCategory, Link, Purchase}
import fr.xebia.ldi.crocodiles.datagen.config.CrocoConf
